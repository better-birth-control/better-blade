<div>
    <script type="text/javascript">
        ...
        _bp_iframe.lang       = '{{ $getLanguage() }}'; /* Language of the form */
        _bp_iframe.width = 600; /* Custom iframe-tag-width, integer */
        _bp_iframe.color = '5665aa'; /* Button and banderole color, hex without "#" */
    ...
    <div id="betterplace_donation_iframe" style="background: transparent url('https://www.betterplace.org/assets/new_spinner.gif') 275px 20px no-repeat;"><strong><a href="https://www.betterplace.org/de/donate/platform/projects/113147-arbeit-des-better-birth-control-e-v">Jetzt Spenden für „Arbeit des Better Birth Control e.V.“ bei unserem Partner betterplace.org</a></strong></div>
</div>
